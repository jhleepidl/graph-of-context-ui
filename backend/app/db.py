...
def _ensure_memory_runtime_columns() -> None:
    ...
    _ensure_table_columns(AgentActivityEvent, {
        "thread_id": str_col,
        "run_id": str_col,
        "event_kind": str_col,
        "event_type": str_col,
        ...
        "summary": text_col,
        "decision": str_col,
        "execution_mode": str_col,
        "workspace_write": str_col,
        "artifact_delivery": str_col,
        "legacy_manual_fallback": str_col,
        "source": str_col,
        "source_event_id": str_col,
        "payload_json": text_col,
        "created_at": ts_col,
        "ingested_at": ts_col,
    }, indexed={"thread_id", "run_id", "event_kind", "event_type", "agent_id", "role_id", "from_agent", "to_agent", "provider", "model", "decision", "execution_mode", "workspace_write", "artifact_delivery", "legacy_manual_fallback", "source", "source_event_id", "created_at", "ingested_at"})
    _ensure_table_columns(AgentPackageRecord, {
        "thread_id": str_col,
        "run_id": str_col,
        "package_id": str_col,
        "title": text_col,
        ...
        "status": str_col,
        "source": str_col,
        "source_thread_id": str_col,
        "source_chat_id": str_col,
        "agent_count": int_col,
        "skill_count": int_col,
        "rule_count": int_col,
        "copies_private_memory": "BOOLEAN",
        "package_json": text_col,
        "created_at": ts_col,
        "updated_at": ts_col,
    }, indexed={"thread_id", "run_id", "package_id", "visibility", "status", "source", "source_thread_id", "source_chat_id", "created_at", "updated_at"})
    _ensure_table_columns(ModelNodeRecord, {
        "node_id": str_col,
        "provider": str_col,
        "runtime": str_col,
        "model": str_col,
        "status": str_col,
        "cost_tier": str_col,
        "latency_tier": str_col,
        "quality_tier": str_col,
        "privacy_tier": str_col,
        "data_boundary": str_col,
        "allow_private_context": "BOOLEAN",
        "context_tokens": int_col,
        "source": str_col,
        "node_json": text_col,
        "last_seen_at": ts_col,
        "updated_at": ts_col,
    }, indexed={"node_id", "provider", "runtime", "model", "status", "cost_tier", "latency_tier", "quality_tier", "privacy_tier", "data_boundary", "allow_private_context", "context_tokens", "source", "last_seen_at", "updated_at"})
    _ensure_table_columns(ModelNodeUsageEvent, {
        "thread_id": str_col,
        "run_id": str_col,
        "node_id": str_col,
        "provider": str_col,
        ...
        "role_id": str_col,
        "task_kind": str_col,
        "prompt_tokens": int_col,
        "completion_tokens": int_col,
        "total_tokens": int_col,
        "latency_ms": int_col,
        "cost_estimate": real_col,
        "event_json": text_col,
        "created_at": ts_col,
    }, indexed={"thread_id", "run_id", "node_id", "provider", "model", "agent_id", "role_id", "task_kind", "total_tokens", "created_at"})
